# Quick instructions for AI coding agents working on ggsegAdhd200
...
- `R/sysdata.rda` — Internal `ggseg_atlas` objects (2D + 3D in one
  object)
- `R/data.R` — Roxygen2 documentation for each atlas (adhd200_200,
  adhd200_400)
- `R/ggsegAdhd200-package.R` — Package-level docs, imports ggseg.formats
